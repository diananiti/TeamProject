...
INSERT INTO USERS  (id, email, name, password, USERNAME ,CREATED_AT, UPDATED_AT) VALUES
  ('1', 'diana@mail.pl', 'Diana', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Diana', now(), now()),
  ('2', 'jakub@mail.pl', 'Jakub', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Jakub', now(), now()),
  ('3', 'tomasz@mail.pl', 'Tomasz', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Tomasz', now(), now()),
  ('4', 'michal@mail.pl', 'Michał', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Michał', now(), now()),
  ('5', 'boguslaw@mail.pl', 'Bogusław', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Bogusław', now(), now()),
  ('6', 'potter@mail.pl', 'Potter', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Potter', now(), now()),
  ('7', 'dambledore@mail.pl', 'Dambledore', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Dambledore', now(), now()),
  ('8', 'snape@mail.pl', 'Snape', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Snape', now(), now()),
  ('9', 'hagrid@mail.pl', 'Hagrid', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Hagrid', now(), now()),
  ('10', 'hermione@mail.pl', 'Hermione', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Hermione', now(), now()),
  ('11', 'ron@mail.pl', 'Ron', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Ron', now(), now()),
  ('12', 'neville@mail.pl', 'Neville', '$2a$10$nZMSBghikje1Iv3NCsdvC.8NB0ZqhOfTDnnIu/mbg6jXWRfgKtyyi', 'Neville', now(), now())
  ;

INSERT INTO PROJECT (ID , NAME , DESCRIPTION , END_DATE, STATUS) VALUES
  ('1', 'Afraid to Fly', 'Quidditch: Roughly takes place during Chapter 7, consisting 4 stages', parsedatetime('17-09-2012 18:47:52.690', 'dd-MM-yyyy hh:mm:ss.SS'), 'In progress'),
  ('2', 'Test of Strength', 'Roughly takes place during Chapter 8, consisting 4 stages:', parsedatetime('17-09-2013 18:47:52.690', 'dd-MM-yyyy hh:mm:ss.SS'), 'In progress'),
  ('3', 'Help Hagrid!', 'Can appear before the completion of the side quest above. Roughly takes place during Chapter 6, consisting 10 stages:', parsedatetime('17-09-2014 18:47:52.690', 'dd-MM-yyyy hh:mm:ss.SS'), 'In progress'),
  ('4', 'Wizarding World Famous', 'Takes place during Chapter 7, consisting 10 stages:', parsedatetime('17-09-2015 18:47:52.690', 'dd-MM-yyyy hh:mm:ss.SS'), 'In progress')
  ;
